...
public class FileResource extends AbstractResource {
    ...
    public FileResource(AppResourceRoot root, String webAppPath, File resource, boolean readOnly, Manifest manifest) {
    ...
    public String getCanonicalPath() {
        try {
            ...
            log.error("failed to getCanonicalPath {}",resource.getPath(),ioe);
            return null;
        }
    }
    ...
    public final byte[] getContent() {
        ...
        if (len > Integer.MAX_VALUE) {
            ...
            throw new ArrayIndexOutOfBoundsException("content is too large," + getAppPath()+" : "+ len);
        }
        ...
        try (InputStream is = new FileInputStream(resource)) {
            ...
            log.error("get content failed with : {}",getAppPath(),ioe);
            return null;
        }
    ...
    public long getCreation() {
        try {
            ...
            log.error("failed to get create time, {}",resource.getPath(),e);
            return 0;
        }
    }
    ...
    public URL getURL() {
        if (resource.exists()) {
            try {
                ...
                log.error("get url failed,{}",resource.getPath(),e);
                return null;
            }
        }
