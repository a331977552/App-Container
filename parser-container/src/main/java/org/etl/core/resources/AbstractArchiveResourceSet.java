...
import org.etl.core.util.ResourceSet;
...
public abstract class AbstractArchiveResourceSet extends AbstractResourceSet {
    ...
    @Override
    public final AppResource getResource(String path) {
        checkPath(path);
        String webAppMount = getWebAppMount();
        AppResourceRoot root = getRoot();
    ...
    protected abstract AppResource createArchiveResource(JarEntry jarEntry, String webAppPath, Manifest manifest);
